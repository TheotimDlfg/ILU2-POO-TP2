...
public class BoundaryAcheterProduit {
	...
	private void effectuerTransaction(String nomAcheteur, String produit, String nomVendeur) {
		...
		if (nbVendu == 0) {
			...
			System.out.println(nomVendeur + " veut acheter " + nbProduit + " " + produit + " malheureusement " + nomVendeur + " n'en a plus que " + nbVendu + ". " + nomAcheteur + " achète tout le stock de " + nomVendeur);
		} else {
